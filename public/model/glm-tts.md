...
A text description of the speech you want to generate

- 最大长度：1024

### input.voice `string` <font color="gray">可选</font>

Voice of the generated speech

- 默认值：`"tongtong"`
- 取值：`tongtong`、`chuichui`、`xiaochen`、`jam`、`kazi`、`douji`、`luodo`

### input.speed `number` <font color="gray">可选</font>

The speed of the generated video.

- 默认值：`1`
- 数值范围：0.5 ~ 2

### input.volume `number` <font color="gray">可选</font>

The volume of the generated video.

- 默认值：`1`
- 数值范围：0 ~ 10

### input.response_format `string` <font color="gray">可选</font>

Response Format of the generated speech
