...
| 字段 | 类型 | 必填 | 本模型取值 | 说明 |
|------|------|------|------------|------|
| `model` | string | 是 | `gemini-3.1-flash-image-preview` | 模型 ID。 |
...
- 默认值：`"1:1"`
- 取值：`1:1`、`1:4`、`1:8`、`2:3`、`3:2`、`3:4`、`4:1`、`4:3`、`4:5`、`5:4`、`8:1`、`9:16`、`16:9`、`21:9`、`auto`
...
### input.google_search `boolean` <font color="gray">可选</font>
...
### input.image_search `boolean` <font color="gray">可选</font>
