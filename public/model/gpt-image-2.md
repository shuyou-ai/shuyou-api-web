...
| 字段 | 类型 | 必填 | 本模型取值 | 说明 |
|------|------|------|------------|------|
| `model` | string | 是 | `gpt-image-2` | 模型 ID。 |
...
### input.output_compression `integer` <font color="gray">可选</font>
